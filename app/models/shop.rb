class Shop
  ...
  def gauge_values
...

    {
      ...
      revenue_per_visit: metrics[:revenue_per_visitor][:value],
      max_revenue_per_visit: metrics[:revenue_per_visitor][:max],
      conversion_rate: metrics[:conversion_rate][:value] * 100,
      max_conversion_rate: metrics[:conversion_rate][:max] * 100,
