class ShopSerializer < ActiveModel::Serializer
  attributes :id, :type, :domain, :token, :name, :timezone, :avg_purchase,
    :max_avg_purchase, :revenue_per_visit, :conversion_rate,
    :max_conversion_rate, :total_orders_today, :total_sales_today,
    :max_total_sales_today, :checkout_distribution, :top_links, :top_searches,
